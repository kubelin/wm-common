package com.samsung.wm.common.factory;
...
public class ModuleServiceFactory {
    ...
    private static class DefaultModuleService implements ModuleService {
        ...
        @Override
        public com.samsung.wm.common.response.CommonResponse<?> process(Map<String, Object> input) {
            return com.samsung.wm.common.response.CommonResponse.error(
                "SERVICE_NOT_FOUND", 
                "해당 서비스를 찾을 수 없습니다"
            );
        }
